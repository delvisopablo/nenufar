...
export const routes: Routes = [
  ...
  { path: 'Nenulista', loadComponent: () => import('./componentes/lista-compra/lista-compra.component').then((m) => m.ListaCompraComponent) },
  { path: 'nenulista', redirectTo: 'Nenulista', pathMatch: 'full' },
  { path: 'lista-compra', redirectTo: 'Nenulista', pathMatch: 'full' },
  ...
  { path: 'negocio/Nenuditar', redirectTo: 'mi-negocio/NNenuditar', pathMatch: 'full' },
