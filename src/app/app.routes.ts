...
export const routes: Routes = [
  ...
  { path: 'perfil/NENUditar', component: PerfilComponent, canActivate: [authToEstanqueGuard] },
  { path: 'mi-perfil', component: PerfilComponent, canActivate: [authToEstanqueGuard] },
  { path: 'mi-perfil/NENUditar', component: PerfilComponent, canActivate: [authToEstanqueGuard] },
  ...
  { path: 'mi-negocio/NENUditar', component: EditarNegocioComponent, canActivate: [authToEstanqueGuard] },
  ...
  { path: 'usuario/NENUditar', component: PerfilComponent, canActivate: [authToEstanqueGuard] },
